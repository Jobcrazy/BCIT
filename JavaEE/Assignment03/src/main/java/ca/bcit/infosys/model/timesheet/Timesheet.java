...
public class Timesheet implements java.io.Serializable {
     ...
     */
    public Timesheet(EmployeeModel employee, LocalDate endDate) {
        details = new ArrayList<TimesheetRow>();
     ...
     *        timesheet
     */
    public Timesheet(final EmployeeModel user, final LocalDate endDate,
     ...
     */
    public void setEmployee(final EmployeeModel user) {
        employee = user;
    }
